    ...
    <section class="py-12">
        <div class="container mx-auto">
            <form class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
                <h2 class="text-2xl font-bold mb-6 text-center">Créez un compte</h2>
                <label class="block mb-2">Nom :</label>
                <input type="text" class="w-full border border-gray-300 rounded-lg p-2 mb-4" required>
                ...
                <button class="w-full bg-yellow-500 text-white py-2 rounded-lg hover:bg-yellow-600">S'inscrire</button>
            </form>
        </div>
    </section>
    <footer>
